...
vggModel.add(ZeroPadding2D((1,1)))
vggModel.add(Conv2D(64, (3,3), strides = (1,1), activation = 'relu'))
...
vggModel.add(ZeroPadding2D((1,1)))
vggModel.add(Conv2D(128, (3,3), strides = (1,1), activation = 'relu'))
...
vggModel.add(ZeroPadding2D((1,1)))
vggModel.add(Conv2D(256, (3,3), strides = (1,1), activation = 'relu'))
...
vggModel.add(ZeroPadding2D((1,1)))
vggModel.add(Conv2D(512, (3,3), strides = (1,1), activation = 'relu'))
